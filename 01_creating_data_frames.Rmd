...
* The '[httr](https://github.com/r-lib/httr)' package provides tools for working with URLs and HTTP.  
```{r}
library(magrittr)
...
The code below shows how to load data from an Excel file stored on the web.
