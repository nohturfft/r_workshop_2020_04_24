...
## Objective  
In this part of the workshop we will use two examples to illustrate how to convert data from a wide to a long (tidy) arrangement and how such data can then be summarised in tubular or graphical format.
...
Load the original data. If ou check the CSV file in Excel, you will notice that the first column does not have a header, so R makes one up ("X1").
```{r}
